...
Mission supplies are free to equip and charged per activation when victory, RTB, or death settles; settlement may create debt. The Ledger has no supply stock. Each bay begins with one authorized activation and earns one more per four completed campaign chapters after its unlock, capped at three independently per bay. The same supply may occupy both bays. Shield Overcharge sets shields to a non-decaying 125%; Armor Sealant restores installed armor to exactly 100% and cannot overplate, repair hull, or help an armorless ship. Redline Impulse adds 100% projectile impulse for 10 seconds, while Sustained Impulse adds 40% for 30 seconds; both feed the existing kinetic/plasma impulse construction instead of applying generic damage. In-flight controls show per-use price, waiver status, and remaining authorization. First-clear samples and DEV grants are fee waivers. Scripted shield/armor pickups apply the identical effect free when at least 10% of the base layer is missing; otherwise they become a sealed claim worth the full item fee on victory/RTB and nothing on death.
