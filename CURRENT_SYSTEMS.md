...
First-clear gear progression uses the same persisted requisition queue. Last Light enqueues separate Pre-Founding primary and survival commissions covering swarm, armor, flexible pressure, shield, plating, and control. Each of the five validated post-Last-Light bosses enqueues another three-role Pre-Founding choice weighted to its encounter lineage. Pending offers are rolled once and saved, avoid already-owned bases when a role pool has alternatives, and cannot duplicate after being claimed. Claimed gear fills an open compatible hardpoint when possible or enters storage; its item popup retains the first-clear mission and selected role as provenance. Act 2's separate salvage table keeps miniboss and boss drops at Prototype-or-better with 20% and 30% Pre-Founding chances respectively, while guaranteed commissions remain additional first-clear rewards.
