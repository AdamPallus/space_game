...
- The player-facing campaign runs from Mission 1 through Mission 8 / Last Light, then continues through five player-validated slices plus two campaign-positioned candidates: Crossed Claims (hybrid), Processional (Chorus swarm), Collateral Choir (evasive Chorus/Tithe hybrid), Repossession (Tithe armor), The Green Signal (Verdant ecology), The Living Current (Verdant shoal), and Return Address (Verdant interception). Collateral Choir appears after Processional; The Living Current appears after The Green Signal. Neither candidate gates the established route until its full-mission playtest establishes that it belongs there. Missions 9–11 and the remaining old Act 2/3 encounter scripts are hidden from the normal board; `?devActs=1` exposes and unlocks them only for agentic regression access.
...
- `Collateral Choir` is an authorized post-Last-Light campaign candidate and is awaiting its first human playtest. It unlocks after Processional, appears immediately before Repossession on the board, grants ordinary Act 2 salvage but no guaranteed first-clear commission, and is not a prerequisite for any existing mission. Phase 8 remains separate brainstorm/spec territory. The old Act 3 missions remain hidden experiments; the future canonical Act 3 must be re-authored mission by mission after the story/economy setup and The Fork. The Fork is a story choice and bridge, not Act 3 itself.
- `The Living Current` is the second campaign candidate. The underlying shoal behavior is player-approved; the new 80-second route from loose currents through Bloomcaller centers, splitting Seedcarriers, a Broodmother handoff, and The Broodwake still needs its full-mission difficulty/readability playtest. It appears between The Green Signal and Return Address, uses ordinary Act 2 salvage plus a Prototype field pod and miniboss/boss drop opportunities, grants no guaranteed commission, and does not yet gate Return Address.
