...
- Repossession proved that random sub-gold salvage is not worth combat risk once gold gear is required. Slice C now supplies Act 2 rarity floors and separate guaranteed gold commissions without special-casing a single encounter; the full acquisition pace awaits the fresh-save progression playtest.
...
- Slice C's guaranteed gear path is implemented and awaiting the required fresh-save progression run through the five validated post-Last-Light missions without Test Arsenal.
