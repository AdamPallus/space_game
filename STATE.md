...
- Return Address is implemented and awaiting its first playtest. It is a gold-tier mothership-interception mission: non-firing Seedcarriers and Rootwards threaten integrity while Burster rammers, Strangler hunters, Thornwing escorts, a spawning Seedcrown, and a carrier-launching Verdant Matriarch disrupt target triage.
...
- No sixth post-Last-Light mission or broader Act 2/3, progression, loot, item, economy, story, or music phase is currently authorized. Those ideas remain draft backlog in `PROGRESSION_MASTER_PLAN.md` and `ROADMAP.md` until Return Address is played.
